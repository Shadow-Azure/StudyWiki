...
- **侧栏可调**：sidebar 与 main 之间是全高 1px 发丝线；线本体不占栅格轨道，背后仅有不可见 7px pointer 命中区，拖拽写入 `--sidebar-size`。210–380px 边界保证 720px 最小窗口下工具条与正文不溢出，键盘左右/Home/End 同步 `aria-valuenow`。
