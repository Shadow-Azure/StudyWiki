...
const ICONS = {
  ...
  bold: [
    ["path", { d: "M4.8 3.2h4.1a2.7 2.7 0 0 1 0 5.4H4.8z" }],
    ["path", { d: "M4.8 8.6h4.7a2.7 2.7 0 0 1 0 5.4H4.8z" }],
  ],
  italic: [
    ["path", { d: "M7 3.2h4.2" }],
    ["path", { d: "M4.8 12.8h4.2" }],
    ["path", { d: "M8.7 3.2 6.3 12.8" }],
  ],
  merge: [
    ["path", { d: "M3 5.2h3.6L10 8l-3.4 2.8H3" }],
    ["path", { d: "M3 8h7" }],
    ["path", { d: "M12.4 5.2v5.6" }],
  ],
  unmerge: [
    ["path", { d: "M3 5.2h3.6L10 8l-3.4 2.8H3" }],
    ["path", { d: "M3 8h7" }],
    ["path", { d: "M12.4 3.6v8.8" }],
    ["path", { d: "M10.5 5.5 12.4 3.6l1.9 1.9" }],
    ["path", { d: "M10.5 10.5l1.9 1.9 1.9-1.9" }],
  ],
  doc: [
